...
let videoInt: number = 13;
let video: HTMLVideoElement  = <HTMLVideoElement>document.getElementById("video");
let sourceString: string[] = ["T1.mp4", "T2.mp4", "T3.mp4", "T4.mp4", "T5.mp4", "T6.mp4", "T7.mp4", "T8.mp4", "T9.mp4", "T10.mp4", "T11.mp4", "T12.mp4", "T13.mp4", "T14.mp4", "T15.mp4"];
