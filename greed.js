...
function hdlLoad() {
    ...
    var hitboxLocation = [{ x: 420, y: 500, s: 100 }, { x: -100, y: -100, s: 100 }, { x: 540, y: 360, s: 150 }, { x: -100, y: -100, s: 100 }, { x: 520, y: 340, s: 200 },
        ...
        { x: 550, y: 230, s: 250 }, { x: -100, y: -100, s: 100 }, { x: 0, y: 0, s: 1300 }, { x: 0, y: 0, s: 0 }, { x: 0, y: 0, s: 0 }];
    ...
    //  5490-5580, 5580-5670, 5670-6000, 6000-6090, 6090-6420, 6420-6510, 6510-6600, 6600-6690, 6690-7200, 7200-7290, extra
    ...
    function hoverVis(vector) {
        ...
        else if (videoInt % 2 == 0) {
            canvas.style.cursor = "url(./Assets/Fist.png) 50 50, auto";
        }
        else {
            canvas.style.cursor = "url(./Assets/FistTrans.png) 50 50, auto";
        }
    }
    function startVideo() {
        console.log(video);
